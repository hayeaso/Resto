...
public class Menus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel9.setText("Les commnades en attente");
        ...
        jLabel12.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(255, 255, 255)));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Numero commande :");
        ...
        jLabel11.setText("Details sur la facture selectionnée");
        ...
        jLabel19.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(255, 255, 255)));
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Erase.png"))); // NOI18N
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (h == (-1)) {
            ...
            try {
                ...
                jLabel10.setText(tm.getValueAt(fmod, 0).toString());
                jLabel12.setText(tm.getValueAt(fmod, 1).toString());
                jLabel19.setText(tm.getValueAt(fmod, 2).toString());
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        int h = jTable2.getSelectedRow();
        if (h == (-1)) {
            JOptionPane.showMessageDialog(null, "Selectionner une facture pour l'annuler");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "facture annuler avec succes ");
                DefaultTableModel dm = (DefaultTableModel) jTable3.getModel();
                int rowCount = dm.getRowCount();
                for (int i = rowCount - 1; i >= 0; i--) {
                    dm.removeRow(i);
